"""
Django settings for pypro02 project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pypro02.modulos.context_processors.listar_modulos',
            ],
        },
    },
]

WSGI_APPLICATION = 'pypro02.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ['https://zanetti-fly-app.fly.dev']
